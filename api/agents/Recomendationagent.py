#Popularity by product
#Popularity by category
#Popularity by apriori
...
class Recommendation_agent():
    ...
    def get_popular_recommendation(self,product_categories=None,top_k=5):
        ...
        recommendations_df = recommendations_df.sort_values(by='no of transaction',ascending=False)
    ...
    def postprocess_classfication(self,output):
        ...
        if type(output['parameters'])==str:
            param=json.loads(output['parameters'])
